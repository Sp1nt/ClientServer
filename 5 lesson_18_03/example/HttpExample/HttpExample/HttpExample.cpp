...
string findValue(const string& jsonString, const string& fieldName) {
...
int main()
{
    ...
    string date = findValue(response, "dt");
    date = convertNumToTime(date);
    string lon = findValue(response, "lon");
    string lat = findValue(response, "lat");
